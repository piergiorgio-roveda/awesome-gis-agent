...
| Name | Description/Comments | Link(s) | Created time |
| --- | --- | --- | --- |
| texttosql_system_using_llm | --- | https://www.reddit.com/r/LangChain/comments/1dtjafd/texttosql_system_using_llm/ | --- |
| From Natural Language to SQL | Approaches and Challenges in Text2SQL | https://toashishagarwal.medium.com/from-natural-language-to-sql-approaches-and-challenges-in-text2sql-d1252ff86321 | --- |
